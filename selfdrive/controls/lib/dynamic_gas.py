...
class DynamicGas:
  ...
  def set_profile(self):
    ...
    if self.dp_profile == DP_ECO:
      ...
      y = [0.35, 0.40, 0.30, 0.24, 0.28, 0.3, 0.29, 0.28, 0.20, 0.16, 0.18, 0.15, 0.18, 0.20, 0.19, 0.18, 0.15, 0.13]
      ...
      y = [0.75, 0.77, 0.63, 0.55, 0.53, 0.53, 0.5529, 0.56784, 0.57765, 0.58, 0.596, 0.509, 0.525, 0.558, 0.52, 0.501, 0.49, 0.45]
