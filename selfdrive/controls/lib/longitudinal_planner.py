...
_A_CRUISE_MIN_V = [-0.99, -.895, -.74, -.58 -.38]
_A_CRUISE_MIN_BP = [  0.,  5.,  10., 20., 40.]

# need fast accel at very low speed for stop and go
# make sure these accelerations are smaller than mpc limits
_A_CRUISE_MAX_V = [1.6, 1.6, 0.85, .5]
_A_CRUISE_MAX_V_FOLLOWING = [2.0, 1.8, 0.85, .5]
...
_DP_CRUISE_MIN_V = [-4.0, -3.5, -3.0, -1.7, -1.0]
_DP_CRUISE_MIN_V_ECO = [-4.0, -3.7, -3.6, -1.5, -0.8]
_DP_CRUISE_MIN_V_SPORT = [-4.0, -3.6, -3.3, -2.5, -1.5]
...
_DP_CRUISE_MAX_V_SPORT = [3.0, 3.5, 3.0, 3.0, 3.0]
_DP_CRUISE_MAX_V_FOLLOWING = [2.6, 2.4, 2.4, 1.7, 1.3]
